...
SCENARIOS = {
    "01_BASIC_ADD_CONFIRM": [
        "Passa al paziente TestAuto1", # Assicuriamoci di essere su un paziente pulito/esistente
...
async def run_scenario(name, steps, llms, log_file):
    ...
    km.set_context("TestAuto1", "caregiver_test")
...
async def main():
    ...
    (Path("data/caregivers") / "caregiver_test.json").write_text(
        '{"caregiver_id": "caregiver_test", "name": "Andrea", "notes": [], "semantic_preferences": []}', encoding="utf-8"
    )
